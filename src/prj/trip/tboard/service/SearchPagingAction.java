...
public class SearchPagingAction implements Action {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totald = dao.getSearchDataCount(keyword); //총 자료수
		List<TBoardVo> boardList = dao.getSearchData(currentPage,dpp-10,keyword);
		if(boardList.size()==0) {
