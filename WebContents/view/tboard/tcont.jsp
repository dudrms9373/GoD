				...
				success:function( json ){
					let tag='';
	        		  ...
	        		  json.cmtList.forEach(function(cmtVo,index){
	        			  ...
	        			  tag+='<tr>';
							tag+='<input type="hidden" name="cmtname'+cnt+'" value="'+cmtVo.cmtNum+'"/>';
							tag+='<td><p>'+cmtVo.cmtNick+'</p><p>'+cmtVo.cmtDate+'</p>';
							tag+= '<a class="reportc'+cnt+'" id="reportc" href="#">신고</a>';
							tag+= '<a class="cmtDel'+cnt+'" id="cmtdelete" href="#">삭제</a>';
							tag+= '<a class="cmtUpd'+cnt+'" id="cmtupdate" href="#">수정</a>';
							tag+= '<a class="cmtLike'+cnt+'" id="cmtlike" href="#">좋아요</a>';
							tag+= '<a class="cmtLikeCancel$'+cnt+'" id="cmtlikeCancel" href="#">좋아요 취소</a><br>';
...
<body>
	...
	<div id="content"><textarea class="bcont" id="bcont" disabled>${ tboardVo.cont }</textarea><br>
	...
	<tr>
	<input type="hidden" name="cmtname${ i }" value="${cmt.cmtNum }"/>
	<td><p>${ cmt.cmtWriter }<p><p>${ cmt.cmtdate }</p>
	<a class="reportc${ i }" id="reportc" href="#">신고</a>
	<a class="cmtDel${ i }" id="cmtdelete" href="#">삭제</a>
	<a class="cmtUpd${ i }" id="cmtupdate" href="#">수정</a>
	<a class="cmtLike${ i }" id="cmtlike" href="#">좋아요</a>
	<a class="cmtLikeCancel${ i }" id="cmtlikeCancel" href="#">좋아요 취소</a><br>
	...
	<a id="cmtdelete" href="#">삭제</a>
	<a id="cmtupdate" href="#">수정</a>
	<a id="cmtlike" href="#">좋아요</a><br>
